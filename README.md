...
- [PowerShell SMTP module](https://learn.microsoft.com/en-us/powershell/module/microsoft.powershell.utility/send-mailmessage?view=powershell-7.4&viewFallbackFrom=powershell-7.1) pour l'envoi d'email (si la fonctionnalité de notification est activée).
